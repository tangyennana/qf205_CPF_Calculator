...
import numpy as np
import pandas as pd
from YearlyCpfContributionForEachAccount import calculate_each_account
from GetCpfYearlyBalance import person
from EscalatingPlan import escalatingPlan
from StandardPlan import standardPlan
from BasicPlan import basic_plan
...
class Ui_cpfcalui(object):
    def setupUi(self, cpfcalui):
        ...
        self.label_9.setGeometry(QtCore.QRect(10, 330, 230, 16))
        self.label_9.setObjectName("label_9")
        self.lineEdit_8 = QtWidgets.QLineEdit(self.tab)
        self.lineEdit_8.setGeometry(QtCore.QRect(240, 330, 91, 22))
    ...
    def retranslateUi(self, cpfcalui):
        ...
        self.lineEdit_11.setText(_translate("cpfcalui", "Amount"))
        ...
        self.lineEdit_16.setText(_translate("cpfcalui", "Amount"))
        ...
        self.lineEdit_18.setText(_translate("cpfcalui", "Amount"))
        ...
        self.label_23.setText(_translate("cpfcalui", ""))
